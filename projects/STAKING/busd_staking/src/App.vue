      ...
      <nav class="navbar navbar-expand-lg navbar-dark mx-auto">
        <div class="container-fluid">
          <router-link
            ...
            "
          >
            <img src="./assets/logo.jpeg" alt="logo" class="navbar-brand p-0" />
      ...
      <div class="footer m-auto">
        <div class="container-fluid">
          <div
            ...
            "
          >
            <a href="https://hazecrypto.net/busdharvest/" target="_blank">
              <img src="./assets/haze.ff55b9b.png" />
            </a>
            <a
              href="https://dappradar.com/binance-smart-chain/high-risk/busdharvest"
              target="_blank"
            >
              <img src="./assets/2a4f7bcb3ea48cf9b412d5d56c13e84c.svg" />
            </a>
            <a href="https://twitter.com/busdharvest" target="_blank"
              ><img
  ...
  methods: {
    ...
    async onProvider(provider) {
      ...
      try {
        ...
        let BUSDInstance = new this.getWeb3.eth.Contract(
          this.getBUSDContractABI,
          this.getBUSDContractAddress
        );
        this.SET_INSTANCE(instance);
        this.SET_BUSDINSTANCE(BUSDInstance);
