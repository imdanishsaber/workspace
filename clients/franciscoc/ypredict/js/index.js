...
const ETH_ADDRESS = "0xE7ec3d790639588b913B6bAf32102956825B3EcE";
...
const POLYGON_ADDRESS = "0xE7ec3d790639588b913B6bAf32102956825B3EcE";
  ...
  methods: {
    ...
    async readValues() {
      ...
      if (this.chainId == 1) {
        ...
        addr = ETH_TOKEN_ADDRESS
      } else {
        name = 'getMATICLatestPrice'
        addr = POLYGON_TOKEN_ADDRESS
      }
      ...
      Promise.all([
        ...
        this.TOKEN_OBJ.methods
          ...
          .call(),
        this.SALE_OBJ.methods.inSale().call(),
        this.SALE_OBJ.methods.salePrice().call(),
        this.SALE_OBJ.methods.nextPrice().call(),
        this.SALE_OBJ.methods.inSaleUSDvalue().call(),
        this.SALE_OBJ.methods[name]().call(),
        this.SALE_OBJ.methods.totalUsdValueForPresale().call(),
        ...
        ([
          ...
          if (tokenBalance == 0) {
            ...
            this.tokenBalance = this.fixedDecimal(parseFloat(tokenBalance / 1e18), 3);
          }

          this.tokenAllowance = Number(
            this.fixedDecimal(parseFloat(tokenAllowance / 1e18), 3)
          );
