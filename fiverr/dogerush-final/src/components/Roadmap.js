        ...
        <>
            <section id='roadmap' className='roadmap' ref={sec}>
                <div className='heading' style={{ overflow: 'hidden' }}>
                    ...
                    >
                        Doge Rush roadmap is a high-level breakdown of the actions we’ve taken, the milestones we’ve unlocked, and the goals we’re striving to achieve our vision for the Doge Rush ecosystem and the $DR token.
                    </p>
                </div>
