      ...
      <div class="row">
          ...
          <div class="card border-0 mb-4">
            ...
            <div class="card-body">
              <div class="d-flex align-items-center mb-4">
                <div class="w-100">
                  <p class="mb-0"><small>EBRY to Harvest:</small></p>
                  <p class="fs-5 fw-bold mb-0">{{ userAvailable }} EBRY</p>
                </div>
                <button
              ...
              <div class="row">
                <div class="col-6 mb-4">
                  <div class="w-100">
                    <p class="mb-0"><small>EBRY in Wallet</small></p>
                    <p class="fs-5 fw-bold mb-0">{{ EBRYBalance }} EBRY</p>
                  </div>
                </div>
                <div class="col-6 mb-4">
                  <div class="w-100">
                    <p class="mb-0"><small>Total Deposit</small></p>
                    <p class="fs-5 fw-bold mb-0">{{ totalDeposit }} EBRY</p>
                  </div>
                </div>
                <div class="col-6 mb-4">
                  <div class="w-100">
                    <p class="mb-0"><small>Total Withdrawn</small></p>
                    <p class="fs-5 fw-bold mb-0">{{ totalWithdrawn }} EBRY</p>
                  </div>
                </div>
                <div class="col-6 col-sm-3 mb-4">
                  <div class="w-100">
                    <p class="mb-0"><small>Referral Earnings</small></p>
                    <p class="fs-5 fw-bold mb-0">{{ totalBonus }} EBRY</p>
                  </div>
                </div>
                <div class="col-6 col-sm-3 mb-4">
                  <div class="w-100">
        ...
        <div class="col-lg-6">
          <div class="card border-0 mb-3">
            ...
            <div class="card-body">
              <p class="mb-0">1 LVL <small>(your invited user)</small> - 5%</p>
              <p class="mb-0">
                2 LVL <small>(user invited by your 1 lvl)</small> - 2.5%
              </p>
              <p class="mb-0">3 LVL - 1.0%</p>
              <p class="mb-0">4 LVL - 0.5%</p>
              <p>5 LVL - 0.2%</p>
                ...
                <div>
                  ...
                  <div class="d-flex w-100">
                    <div class="mb-0 w-100 p-2 ps-3 bg-white rounded me-n11">
                      ...
                      >
                        {{ "https://farm.ethbinary.com/?ref=" + getUserAccount }}
                      </small>
                    </div>
        ...
        <div class="col-lg-12">
          <div class="card border-0 mb-3">
            <div class="card-header bg-white border-0 pb-0">
              <p class="card-title mb-0">Stake EBRY</p>
            </div>
              ...
              <table class="table">
                ...
                <tbody class="position-relative">
                  <tr class="cursor-pointer" @click="row_one = !row_one">
                    <td scope="row"><span> 1825 </span></td>
                    <td scope="row"><span> 0.2% </span></td>
                    <td scope="row"><span> 365% </span></td>
                    <td scope="row"></td>
                    <td scope="row">
                          ...
                          <div class="p-1 pe-3">
                            ...
                            >
                              <span class="text-capitalize me-3"
                                >EBRY Available: {{ EBRYBalance }}
                              </span>
                              <div>
                                <span
                                  v-if="isApproved"
                                  class="text-capitalize me-3"
                                  >Total Earn: ∞ EBRY</span
                                >
                                <button
                                  @click="(rate = 0.2), (showModal = !showModal)"
                ...
                <tbody class="position-relative">
                  <tr class="cursor-pointer" @click="row_two = !row_two">
                    ...
                    <td scope="row"><span> 0.5% </span></td>
                    <td scope="row"><span> 15% </span></td>
                    <td scope="row"></td>
                    <td scope="row">
                      <button class="border-0 bg-transparent">
                        <span class="angle mb-1"></span>
                            ...
                            >
                              ...
                              <div>
                                <span
                                  ...
                                  class="text-capitalize me-3"
                                  >Total Earn:
                                  {{ total_earning_two }} EBRY</span
                                >
                                <button
                                  @click="(rate = 0.5), (showModal = !showModal)"
                                  class="border-0 bg-transparent ms-auto"
                                >
                                  <img
                                    src="../assets/520294a18c7cf5bc4e34af55694a95f9.svg"
                            ...
                            >
                              ...
                              <div>
                                <span
                                  ...
                                  class="text-capitalize me-3"
                                  >Total Earn:
                                  {{ total_earning_three }} EBRY</span
                                >
                                <button
                                  @click="
                                    (rate = 1), (showModal = !showModal)
                                  "
                                  class="border-0 bg-transparent ms-auto"
                                >
                                  <img
                ...
                <tbody class="position-relative">
                  <tr class="cursor-pointer" @click="row_four = !row_four">
                    ...
                    <td scope="row"><span> 1.5% </span></td>
                    <td scope="row"><span> 135% </span></td>
                    <td scope="row"></td>
                    <td scope="row">
                      <button class="border-0 bg-transparent">
                        <span class="angle mb-1"></span>
                            ...
                            >
                              ...
                              <div>
                                <span
                                  ...
                                  class="text-capitalize me-3"
                                  >Total Earn:
                                  {{ total_earning_four }} EBRY</span
                                >
                                <button
                                  @click="(rate = 1.5), (showModal = !showModal)"
                                  class="border-0 bg-transparent ms-auto"
                                >
                                  <img
                                    src="../assets/520294a18c7cf5bc4e34af55694a95f9.svg"
          ...
          <div class="card border-0 mb-3">
            ...
            <div class="card-body">
              <small class="fw-light mt-n3 d-block lh-xs">
                ...
                possible only if contract balance have enough EBRY. Please
  ...
  methods: {
    ...
    readValue() {
      if (this.getWeb3) {
        ...
        Promise.all([
          this.getEBRYInstance.methods.balanceOf(this.getUserAccount).call(),
          this.getEBRYInstance.methods
          ...
          ([
            ...
            console.log(EBRYBalance, allowance, userInfo, userAvailable, totalReferrals, totalWithdrawn, totalBonus)
            if (allowance > 0) this.isApproved = true;
            this.EBRYBalance = this.humanized(EBRYBalance, 3);
